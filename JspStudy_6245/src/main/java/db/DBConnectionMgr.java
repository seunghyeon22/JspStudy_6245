...
public class DBConnectionMgr {
    ...
    private String _driver = "org.mariadb.jdbc.Driver", //mvn을 xml파일에 설정 maven 에서 db위치 확인하고 설정
    _url = "jdbc:mariadb://127.0.0.1:8001/jsp-song?useUnicode=true&characterEncoding=UTF-8", // jdbc : 사용db // 포트번호/db이름?유니코드 사용여부&인코딩 타입 확인
    _user = "root",
    _password = "root";
